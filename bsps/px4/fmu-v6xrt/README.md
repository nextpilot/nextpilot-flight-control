...
总线 | 是否启用 | 用途
--- | --- | ---
I2C1 | √ | 引出到gps1，一般接LED，或者SMBUS
I2C2 | √ | 1. 引出去到gps2，一般接LED，或者SMBUS<br />2. 1176核心板，用于BMP388气压计
I2C3 | √ | 1. 独立IMU板，用于BMP388气压计<br />2. 1176核心板，安全芯片SEM051
I2C4 | √ | 独立IMU板，磁罗盘BMM150，还有校准用的24LC64T（EPPROM）
I2C5 | x | 没用到
I2C6 | √ | 1. 引出到外部使用<br />2. 1176核心板，校准用24LC64T及安全芯片SEM051
