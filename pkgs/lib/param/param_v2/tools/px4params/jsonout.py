            ...
            "items": {
                "parameters": {
                    "list": {
                        ...
                        "items": {
                            "bitmask": {"list": {"key": "index", "translate": ["description"]}},
                            "values": {"list": {"key": "value", "translate": ["description"]}},
                        },
                    }
                }
            }
        ...
        for group in groups:
            ...
            for param in group.GetParams():
                if (last_param_name == param.GetName() and not board_specific_param_set) or last_param_name != param.GetName():
                    ...
                    for code in param.GetFieldCodes():
                        ...
                        if code == "board":
                            ...
                            # map param field names to schema names
                ...
                if enum_codes:
                    ...
                    curr_param["values"] = [{"value": 0, "description": "Disabled"}, {"value": 1, "description": "Enabled"}]
