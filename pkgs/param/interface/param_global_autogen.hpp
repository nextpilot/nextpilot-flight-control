...
enum class params_id : uint16_t {
	...
	MC_BAT_SCALE_EN = 877,
	MC_MAN_TILT_TAU = 878,
	MC_ORBIT_RAD_MAX = 879,
	MC_PITCHRATE_D = 880,
	MC_PITCHRATE_FF = 881,
	MC_PITCHRATE_I = 882,
	MC_PITCHRATE_K = 883,
	MC_PITCHRATE_MAX = 884,
	MC_PITCHRATE_P = 885,
	MC_PITCH_P = 886,
	MC_PR_INT_LIM = 887,
	MC_ROLLRATE_D = 888,
	...
	MC_YR_INT_LIM = 904,
	MIS_DIST_1WP = 905,
	MIS_LND_ABRT_ALT = 906,
	MIS_MNT_YAW_CTL = 907,
	MIS_PD_TO = 908,
	MIS_TAKEOFF_ALT = 909,
	MIS_TKO_LAND_REQ = 910,
	MIS_YAW_ERR = 911,
	MIS_YAW_TMT = 912,
	MOT_SLEW_MAX = 913,
	MPC_ACC_DOWN_MAX = 914,
	MPC_ACC_HOR = 915,
	MPC_ACC_HOR_MAX = 916,
	MPC_ACC_UP_MAX = 917,
	MPC_ALT_MODE = 918,
	...
	MPC_LAND_CRWL = 927,
	MPC_LAND_RADIUS = 928,
	MPC_LAND_RC_HELP = 929,
	MPC_LAND_SPEED = 930,
	MPC_MANTHR_MIN = 931,
	MPC_MAN_TILT_MAX = 932,
	MPC_MAN_Y_MAX = 933,
	MPC_MAN_Y_TAU = 934,
	MPC_POS_MODE = 935,
	MPC_THR_CURVE = 936,
	...
	MPC_VELD_LP = 946,
	MPC_VEL_MANUAL = 947,
	MPC_VEL_MAN_BACK = 948,
	MPC_VEL_MAN_SIDE = 949,
	MPC_XY_CRUISE = 950,
	MPC_XY_ERR_MAX = 951,
	MPC_XY_MAN_EXPO = 952,
	MPC_XY_P = 953,
	MPC_XY_TRAJ_P = 954,
	MPC_XY_VEL_ALL = 955,
	MPC_XY_VEL_D_ACC = 956,
	MPC_XY_VEL_I_ACC = 957,
	MPC_XY_VEL_MAX = 958,
	MPC_XY_VEL_P_ACC = 959,
	MPC_YAWRAUTO_MAX = 960,
	MPC_YAW_EXPO = 961,
	MPC_YAW_MODE = 962,
	MPC_Z_MAN_EXPO = 963,
	MPC_Z_P = 964,
	...
	MPC_Z_VEL_D_ACC = 966,
	MPC_Z_VEL_I_ACC = 967,
	MPC_Z_VEL_MAX_DN = 968,
	MPC_Z_VEL_MAX_UP = 969,
	MPC_Z_VEL_P_ACC = 970,
	MPC_Z_V_AUTO_DN = 971,
	MPC_Z_V_AUTO_UP = 972,
	NAV_ACC_RAD = 973,
	...
	RC9_REV = 1091,
	RC9_TRIM = 1092,
	RC_ARMSWITCH_TH = 1093,
	RC_CHAN_CNT = 1094,
	RC_ENG_MOT_TH = 1095,
	RC_FAILS_THR = 1096,
	RC_GEAR_TH = 1097,
	RC_KILLSWITCH_TH = 1098,
	RC_LOITER_TH = 1099,
	RC_MAP_ACRO_SW = 1100,
	RC_MAP_ARM_SW = 1101,
	RC_MAP_AUX1 = 1102,
	...
	RC_MAP_AUX6 = 1107,
	RC_MAP_ENG_MOT = 1108,
	RC_MAP_FAILSAFE = 1109,
	RC_MAP_FLAPS = 1110,
	RC_MAP_FLTMODE = 1111,
	RC_MAP_FLTM_BTN = 1112,
	RC_MAP_GEAR_SW = 1113,
	RC_MAP_KILL_SW = 1114,
	RC_MAP_LOITER_SW = 1115,
	RC_MAP_MAN_SW = 1116,
	RC_MAP_MODE_SW = 1117,
	RC_MAP_OFFB_SW = 1118,
	RC_MAP_PARAM1 = 1119,
	...
	RC_MAP_PARAM3 = 1121,
	RC_MAP_PITCH = 1122,
	RC_MAP_POSCTL_SW = 1123,
	RC_MAP_RATT_SW = 1124,
	RC_MAP_RETURN_SW = 1125,
	RC_MAP_ROLL = 1126,
	RC_MAP_STAB_SW = 1127,
	RC_MAP_THROTTLE = 1128,
	RC_MAP_TRANS_SW = 1129,
	RC_MAP_YAW = 1130,
	RC_OFFB_TH = 1131,
	RC_RETURN_TH = 1132,
	RC_RSSI_PWM_CHAN = 1133,
	RC_RSSI_PWM_MAX = 1134,
	RC_RSSI_PWM_MIN = 1135,
	RC_TRANS_TH = 1136,
	RTL_CONE_ANG = 1137,
	RTL_DESCEND_ALT = 1138,
	RTL_HDG_MD = 1139,
	RTL_LAND_DELAY = 1140,
	RTL_LOITER_RAD = 1141,
	RTL_MIN_DIST = 1142,
	RTL_PLD_MD = 1143,
	RTL_RETURN_ALT = 1144,
	RTL_TIME_FACTOR = 1145,
	RTL_TIME_MARGIN = 1146,
	RTL_TYPE = 1147,
	RWTO_HDG = 1148,
	RWTO_MAX_THR = 1149,
	RWTO_NPFG_PERIOD = 1150,
	RWTO_NUDGE = 1151,
	RWTO_PSP = 1152,
	RWTO_RAMP_TIME = 1153,
	RWTO_ROT_AIRSPD = 1154,
	RWTO_ROT_TIME = 1155,
	RWTO_TKOFF = 1156,
	SDLOG_ALGORITHM = 1157,
	SDLOG_BOOT_BAT = 1158,
	SDLOG_DIRS_MAX = 1159,
	SDLOG_EXCH_KEY = 1160,
	SDLOG_KEY = 1161,
	...
	SDLOG_MODE = 1163,
	SDLOG_PROFILE = 1164,
	SDLOG_UTC_OFFSET = 1165,
	SDLOG_UUID = 1166,
	SENS_BARO_QNH = 1167,
	SENS_BARO_RATE = 1168,
	SENS_BOARD_ROT = 1169,
	SENS_BOARD_X_OFF = 1170,
	SENS_BOARD_Y_OFF = 1171,
	SENS_BOARD_Z_OFF = 1172,
	SENS_DPRES_ANSC = 1173,
	SENS_DPRES_OFF = 1174,
	SENS_EN_ARSPDSIM = 1175,
	SENS_EN_BAROSIM = 1176,
	SENS_EN_GPSSIM = 1177,
	SENS_EN_MAGSIM = 1178,
	SENS_EN_THERMAL = 1179,
	SENS_EXT_I2C_PRB = 1180,
	SENS_FLOW_MAXHGT = 1181,
	SENS_FLOW_MAXR = 1182,
	SENS_FLOW_MINHGT = 1183,
	SENS_FLOW_RATE = 1184,
	SENS_FLOW_ROT = 1185,
	SENS_GPS_MASK = 1186,
	SENS_GPS_PRIME = 1187,
	SENS_GPS_TAU = 1188,
	SENS_IMU_AUTOCAL = 1189,
	SENS_IMU_MODE = 1190,
	SENS_INT_BARO_EN = 1191,
	SENS_MAG_AUTOCAL = 1192,
	SENS_MAG_AUTOROT = 1193,
	SENS_MAG_MODE = 1194,
	SENS_MAG_RATE = 1195,
	SENS_MAG_SIDES = 1196,
	SIH_DISTSNSR_MAX = 1197,
	SIH_DISTSNSR_MIN = 1198,
	SIH_DISTSNSR_OVR = 1199,
	SIH_IXX = 1200,
	SIH_IXY = 1201,
	SIH_IXZ = 1202,
	SIH_IYY = 1203,
	...
	SIH_T_MAX = 1215,
	SIH_T_TAU = 1216,
	SIH_VEHICLE_TYPE = 1217,
	SIM_ARSPD_FAIL = 1218,
	SIM_BARO_OFF_P = 1219,
	SIM_BARO_OFF_T = 1220,
	SIM_BAT_DRAIN = 1221,
	SIM_BAT_MIN_PCT = 1222,
	SIM_GPS_USED = 1223,
	SIM_GZ_EC_DIS1 = 1224,
	SIM_GZ_EC_DIS2 = 1225,
	SIM_GZ_EC_DIS3 = 1226,
	...
	SIM_GZ_EC_DIS7 = 1230,
	SIM_GZ_EC_DIS8 = 1231,
	SIM_GZ_EC_FAIL1 = 1232,
	SIM_GZ_EC_FAIL2 = 1233,
	SIM_GZ_EC_FAIL3 = 1234,
	SIM_GZ_EC_FAIL4 = 1235,
	SIM_GZ_EC_FAIL5 = 1236,
	SIM_GZ_EC_FAIL6 = 1237,
	SIM_GZ_EC_FAIL7 = 1238,
	SIM_GZ_EC_FAIL8 = 1239,
	SIM_GZ_EC_FUNC1 = 1240,
	SIM_GZ_EC_FUNC2 = 1241,
	SIM_GZ_EC_FUNC3 = 1242,
	SIM_GZ_EC_FUNC4 = 1243,
	SIM_GZ_EC_FUNC5 = 1244,
	SIM_GZ_EC_FUNC6 = 1245,
	SIM_GZ_EC_FUNC7 = 1246,
	SIM_GZ_EC_FUNC8 = 1247,
	SIM_GZ_EC_MAX1 = 1248,
	SIM_GZ_EC_MAX2 = 1249,
	SIM_GZ_EC_MAX3 = 1250,
	SIM_GZ_EC_MAX4 = 1251,
	...
	SIM_GZ_EC_REV = 1264,
	SIM_GZ_EN = 1265,
	SIM_GZ_HOME_ALT = 1266,
	SIM_GZ_HOME_LAT = 1267,
	SIM_GZ_HOME_LON = 1268,
	SIM_GZ_SV_DIS1 = 1269,
	SIM_GZ_SV_DIS2 = 1270,
	SIM_GZ_SV_DIS3 = 1271,
	SIM_GZ_SV_DIS4 = 1272,
	...
	SIM_GZ_SV_DIS7 = 1275,
	SIM_GZ_SV_DIS8 = 1276,
	SIM_GZ_SV_FAIL1 = 1277,
	SIM_GZ_SV_FAIL2 = 1278,
	SIM_GZ_SV_FAIL3 = 1279,
	SIM_GZ_SV_FAIL4 = 1280,
	SIM_GZ_SV_FAIL5 = 1281,
	SIM_GZ_SV_FAIL6 = 1282,
	SIM_GZ_SV_FAIL7 = 1283,
	SIM_GZ_SV_FAIL8 = 1284,
	SIM_GZ_SV_FUNC1 = 1285,
	SIM_GZ_SV_FUNC2 = 1286,
	SIM_GZ_SV_FUNC3 = 1287,
	SIM_GZ_SV_FUNC4 = 1288,
	SIM_GZ_SV_FUNC5 = 1289,
	SIM_GZ_SV_FUNC6 = 1290,
	SIM_GZ_SV_FUNC7 = 1291,
	SIM_GZ_SV_FUNC8 = 1292,
	SIM_GZ_SV_MAX1 = 1293,
	SIM_GZ_SV_MAX2 = 1294,
	SIM_GZ_SV_MAX3 = 1295,
	SIM_GZ_SV_MAX4 = 1296,
	...
	SIM_GZ_SV_MIN8 = 1308,
	SIM_GZ_SV_REV = 1309,
	SIM_MAG_OFFSET_X = 1310,
	SIM_MAG_OFFSET_Y = 1311,
	SIM_MAG_OFFSET_Z = 1312,
	SYS_AUTOCONFIG = 1313,
	SYS_AUTOSTART = 1314,
	SYS_BL_UPDATE = 1315,
	SYS_CAL_ACCEL = 1316,
	...
	SYS_CAL_TMIN = 1321,
	SYS_DM_BACKEND = 1322,
	SYS_FAC_CAL_MODE = 1323,
	SYS_FAILURE_EN = 1324,
	SYS_HAS_BARO = 1325,
	SYS_HAS_GPS = 1326,
	SYS_HAS_MAG = 1327,
	SYS_HAS_NUM_DIST = 1328,
	SYS_HITL = 1329,
	SYS_MC_EST_GROUP = 1330,
	SYS_RGB_MAXBRT = 1331,
	SYS_VEHICLE_RESP = 1332,
	SYS_VEHICLE_TYPE = 1333,
	TEST_D = 1334,
	TEST_DEV = 1335,
	TEST_D_LP = 1336,
	TEST_HP = 1337,
	...
	VT_B_DEC_MSS = 1355,
	VT_B_TRANS_DUR = 1356,
	VT_B_TRANS_RAMP = 1357,
	VT_ELEV_MC_LOCK = 1358,
	VT_FWD_THRUST_EN = 1359,
	VT_FWD_THRUST_SC = 1360,
	VT_FW_DIFTHR_EN = 1361,
	VT_FW_DIFTHR_S_P = 1362,
	VT_FW_DIFTHR_S_R = 1363,
	VT_FW_DIFTHR_S_Y = 1364,
	VT_FW_MIN_ALT = 1365,
	VT_FW_QC_HMAX = 1366,
	VT_FW_QC_P = 1367,
	VT_FW_QC_R = 1368,
	...
	VT_F_TRANS_THR = 1370,
	VT_F_TR_OL_TM = 1371,
	VT_LND_PITCH_MIN = 1372,
	VT_PITCH_MIN = 1373,
	VT_PSHER_SLEW = 1374,
	VT_QC_ALT_LOSS = 1375,
	VT_QC_T_ALT_LOSS = 1376,
	VT_SPOILER_MC_LD = 1377,
	VT_TILT_FW = 1378,
	VT_TILT_MC = 1379,
	VT_TILT_SPINUP = 1380,
	VT_TILT_TRANS = 1381,
	VT_TRANS_MIN_TM = 1382,
	VT_TRANS_P2_DUR = 1383,
	VT_TRANS_TIMEOUT = 1384,
	VT_TYPE = 1385,
	WEIGHT_BASE = 1386,
	WEIGHT_GROSS = 1387,
	WV_EN = 1388,
