...
enum class params_id : uint16_t {
	...
	MPC_LAND_CRWL = 947,
	MPC_LAND_RADIUS = 948,
	MPC_LAND_RC_HELP = 949,
	MPC_LAND_SPEED = 950,
	MPC_MANTHR_MIN = 951,
	MPC_MAN_TILT_MAX = 952,
	MPC_MAN_Y_MAX = 953,
	MPC_MAN_Y_TAU = 954,
	MPC_POS_MODE = 955,
	MPC_THR_CURVE = 956,
	...
	MPC_VELD_LP = 966,
	MPC_VEL_MANUAL = 967,
	MPC_VEL_MAN_BACK = 968,
	MPC_VEL_MAN_SIDE = 969,
	MPC_XY_CRUISE = 970,
	MPC_XY_ERR_MAX = 971,
	MPC_XY_MAN_EXPO = 972,
	MPC_XY_P = 973,
	MPC_XY_TRAJ_P = 974,
	MPC_XY_VEL_ALL = 975,
	MPC_XY_VEL_D_ACC = 976,
	MPC_XY_VEL_I_ACC = 977,
	MPC_XY_VEL_MAX = 978,
	MPC_XY_VEL_P_ACC = 979,
	MPC_YAWRAUTO_MAX = 980,
	MPC_YAW_EXPO = 981,
	MPC_YAW_MODE = 982,
	MPC_Z_MAN_EXPO = 983,
	MPC_Z_P = 984,
	...
	MPC_Z_VEL_D_ACC = 986,
	MPC_Z_VEL_I_ACC = 987,
	MPC_Z_VEL_MAX_DN = 988,
	MPC_Z_VEL_MAX_UP = 989,
	MPC_Z_VEL_P_ACC = 990,
	MPC_Z_V_AUTO_DN = 991,
	MPC_Z_V_AUTO_UP = 992,
	NAV_ACC_RAD = 993,
	...
	NAV_LOITER_RAD = 998,
	NAV_MC_ALT_RAD = 999,
	NAV_MIN_LTR_ALT = 1000,
	NAV_RCL_ACT = 1001,
	NAV_TRAFF_AVOID = 1002,
	NAV_TRAFF_A_HOR = 1003,
	NAV_TRAFF_A_VER = 1004,
	NAV_TRAFF_COLL_T = 1005,
	NPFG_DAMPING = 1006,
	NPFG_EN_MIN_GSP = 1007,
	NPFG_GSP_MAX_TK = 1008,
	NPFG_LB_PERIOD = 1009,
	NPFG_PERIOD = 1010,
	NPFG_PERIOD_SF = 1011,
	NPFG_ROLL_TC = 1012,
	NPFG_SW_DST_MLT = 1013,
	NPFG_TRACK_KEEP = 1014,
	NPFG_UB_PERIOD = 1015,
	NPFG_WIND_REG = 1016,
	PLD_BTOUT = 1017,
	PLD_FAPPR_ALT = 1018,
	...
	RC9_REV = 1111,
	RC9_TRIM = 1112,
	RC_ARMSWITCH_TH = 1113,
	RC_CHAN_CNT = 1114,
	RC_ENG_MOT_TH = 1115,
	RC_FAILS_THR = 1116,
	RC_GEAR_TH = 1117,
	RC_KILLSWITCH_TH = 1118,
	RC_LOITER_TH = 1119,
	RC_MAP_ACRO_SW = 1120,
	RC_MAP_ARM_SW = 1121,
	RC_MAP_AUX1 = 1122,
	...
	RC_MAP_AUX6 = 1127,
	RC_MAP_ENG_MOT = 1128,
	RC_MAP_FAILSAFE = 1129,
	RC_MAP_FLAPS = 1130,
	RC_MAP_FLTMODE = 1131,
	RC_MAP_FLTM_BTN = 1132,
	RC_MAP_GEAR_SW = 1133,
	RC_MAP_KILL_SW = 1134,
	RC_MAP_LOITER_SW = 1135,
	RC_MAP_MAN_SW = 1136,
	RC_MAP_MODE_SW = 1137,
	RC_MAP_OFFB_SW = 1138,
	RC_MAP_PARAM1 = 1139,
	...
	RC_MAP_PARAM3 = 1141,
	RC_MAP_PITCH = 1142,
	RC_MAP_POSCTL_SW = 1143,
	RC_MAP_RATT_SW = 1144,
	RC_MAP_RETURN_SW = 1145,
	RC_MAP_ROLL = 1146,
	RC_MAP_STAB_SW = 1147,
	RC_MAP_THROTTLE = 1148,
	RC_MAP_TRANS_SW = 1149,
	RC_MAP_YAW = 1150,
	RC_OFFB_TH = 1151,
	RC_RETURN_TH = 1152,
	RC_RSSI_PWM_CHAN = 1153,
	RC_RSSI_PWM_MAX = 1154,
	RC_RSSI_PWM_MIN = 1155,
	RC_TRANS_TH = 1156,
	RTL_CONE_ANG = 1157,
	RTL_DESCEND_ALT = 1158,
	RTL_HDG_MD = 1159,
	RTL_LAND_DELAY = 1160,
	RTL_LOITER_RAD = 1161,
	RTL_MIN_DIST = 1162,
	RTL_PLD_MD = 1163,
	RTL_RETURN_ALT = 1164,
	RTL_TIME_FACTOR = 1165,
	RTL_TIME_MARGIN = 1166,
	RTL_TYPE = 1167,
	RWTO_HDG = 1168,
	RWTO_MAX_THR = 1169,
	RWTO_NPFG_PERIOD = 1170,
	RWTO_NUDGE = 1171,
	RWTO_PSP = 1172,
	RWTO_RAMP_TIME = 1173,
	RWTO_ROT_AIRSPD = 1174,
	RWTO_ROT_TIME = 1175,
	RWTO_TKOFF = 1176,
	SDLOG_ALGORITHM = 1177,
	SDLOG_BOOT_BAT = 1178,
	SDLOG_DIRS_MAX = 1179,
	SDLOG_EXCH_KEY = 1180,
	SDLOG_KEY = 1181,
	...
	SDLOG_MODE = 1183,
	SDLOG_PROFILE = 1184,
	SDLOG_UTC_OFFSET = 1185,
	SDLOG_UUID = 1186,
	SENS_BARO_QNH = 1187,
	SENS_BARO_RATE = 1188,
	SENS_BOARD_ROT = 1189,
	SENS_BOARD_X_OFF = 1190,
	SENS_BOARD_Y_OFF = 1191,
	SENS_BOARD_Z_OFF = 1192,
	SENS_DPRES_ANSC = 1193,
	SENS_DPRES_OFF = 1194,
	SENS_EN_ARSPDSIM = 1195,
	SENS_EN_BAROSIM = 1196,
	SENS_EN_GPSSIM = 1197,
	SENS_EN_MAGSIM = 1198,
	SENS_EN_THERMAL = 1199,
	SENS_EXT_I2C_PRB = 1200,
	SENS_FLOW_MAXHGT = 1201,
	SENS_FLOW_MAXR = 1202,
	SENS_FLOW_MINHGT = 1203,
	SENS_FLOW_RATE = 1204,
	SENS_FLOW_ROT = 1205,
	SENS_GPS_MASK = 1206,
	SENS_GPS_PRIME = 1207,
	SENS_GPS_TAU = 1208,
	SENS_IMU_AUTOCAL = 1209,
	SENS_IMU_MODE = 1210,
	SENS_INT_BARO_EN = 1211,
	SENS_MAG_AUTOCAL = 1212,
	SENS_MAG_AUTOROT = 1213,
	SENS_MAG_MODE = 1214,
	SENS_MAG_RATE = 1215,
	SENS_MAG_SIDES = 1216,
	SIH_DISTSNSR_MAX = 1217,
	SIH_DISTSNSR_MIN = 1218,
	SIH_DISTSNSR_OVR = 1219,
	SIH_IXX = 1220,
	SIH_IXY = 1221,
	SIH_IXZ = 1222,
	SIH_IYY = 1223,
	...
	SIH_T_MAX = 1235,
	SIH_T_TAU = 1236,
	SIH_VEHICLE_TYPE = 1237,
	SIM_ARSPD_FAIL = 1238,
	SIM_BARO_OFF_P = 1239,
	SIM_BARO_OFF_T = 1240,
	SIM_BAT_DRAIN = 1241,
	SIM_BAT_MIN_PCT = 1242,
	SIM_GPS_USED = 1243,
	SIM_GZ_EC_DIS1 = 1244,
	SIM_GZ_EC_DIS2 = 1245,
	SIM_GZ_EC_DIS3 = 1246,
	...
	SIM_GZ_EC_DIS7 = 1250,
	SIM_GZ_EC_DIS8 = 1251,
	SIM_GZ_EC_FAIL1 = 1252,
	SIM_GZ_EC_FAIL2 = 1253,
	SIM_GZ_EC_FAIL3 = 1254,
	SIM_GZ_EC_FAIL4 = 1255,
	SIM_GZ_EC_FAIL5 = 1256,
	SIM_GZ_EC_FAIL6 = 1257,
	SIM_GZ_EC_FAIL7 = 1258,
	SIM_GZ_EC_FAIL8 = 1259,
	SIM_GZ_EC_FUNC1 = 1260,
	SIM_GZ_EC_FUNC2 = 1261,
	SIM_GZ_EC_FUNC3 = 1262,
	SIM_GZ_EC_FUNC4 = 1263,
	SIM_GZ_EC_FUNC5 = 1264,
	SIM_GZ_EC_FUNC6 = 1265,
	SIM_GZ_EC_FUNC7 = 1266,
	SIM_GZ_EC_FUNC8 = 1267,
	SIM_GZ_EC_MAX1 = 1268,
	SIM_GZ_EC_MAX2 = 1269,
	SIM_GZ_EC_MAX3 = 1270,
	SIM_GZ_EC_MAX4 = 1271,
	...
	SIM_GZ_EC_REV = 1284,
	SIM_GZ_EN = 1285,
	SIM_GZ_HOME_ALT = 1286,
	SIM_GZ_HOME_LAT = 1287,
	SIM_GZ_HOME_LON = 1288,
	SIM_GZ_SV_DIS1 = 1289,
	SIM_GZ_SV_DIS2 = 1290,
	SIM_GZ_SV_DIS3 = 1291,
	SIM_GZ_SV_DIS4 = 1292,
	...
	SIM_GZ_SV_DIS7 = 1295,
	SIM_GZ_SV_DIS8 = 1296,
	SIM_GZ_SV_FAIL1 = 1297,
	SIM_GZ_SV_FAIL2 = 1298,
	SIM_GZ_SV_FAIL3 = 1299,
	SIM_GZ_SV_FAIL4 = 1300,
	SIM_GZ_SV_FAIL5 = 1301,
	SIM_GZ_SV_FAIL6 = 1302,
	SIM_GZ_SV_FAIL7 = 1303,
	SIM_GZ_SV_FAIL8 = 1304,
	SIM_GZ_SV_FUNC1 = 1305,
	SIM_GZ_SV_FUNC2 = 1306,
	SIM_GZ_SV_FUNC3 = 1307,
	SIM_GZ_SV_FUNC4 = 1308,
	SIM_GZ_SV_FUNC5 = 1309,
	SIM_GZ_SV_FUNC6 = 1310,
	SIM_GZ_SV_FUNC7 = 1311,
	SIM_GZ_SV_FUNC8 = 1312,
	SIM_GZ_SV_MAX1 = 1313,
	SIM_GZ_SV_MAX2 = 1314,
	SIM_GZ_SV_MAX3 = 1315,
	SIM_GZ_SV_MAX4 = 1316,
	...
	SIM_GZ_SV_MIN8 = 1328,
	SIM_GZ_SV_REV = 1329,
	SIM_MAG_OFFSET_X = 1330,
	SIM_MAG_OFFSET_Y = 1331,
	SIM_MAG_OFFSET_Z = 1332,
	SYS_AUTOCONFIG = 1333,
	SYS_AUTOSTART = 1334,
	SYS_BL_UPDATE = 1335,
	SYS_CAL_ACCEL = 1336,
	...
	SYS_CAL_TMIN = 1341,
	SYS_DM_BACKEND = 1342,
	SYS_FAC_CAL_MODE = 1343,
	SYS_FAILURE_EN = 1344,
	SYS_HAS_BARO = 1345,
	SYS_HAS_GPS = 1346,
	SYS_HAS_MAG = 1347,
	SYS_HAS_NUM_DIST = 1348,
	SYS_HITL = 1349,
	SYS_MC_EST_GROUP = 1350,
	SYS_RGB_MAXBRT = 1351,
	SYS_VEHICLE_RESP = 1352,
	SYS_VEHICLE_TYPE = 1353,
	TC_A0_ID = 1354,
	TC_A0_TMAX = 1355,
	TC_A0_TMIN = 1356,
	TC_A0_TREF = 1357,
	...
	VT_B_DEC_MSS = 1546,
	VT_B_TRANS_DUR = 1547,
	VT_B_TRANS_RAMP = 1548,
	VT_ELEV_MC_LOCK = 1549,
	VT_FWD_THRUST_EN = 1550,
	VT_FWD_THRUST_SC = 1551,
	VT_FW_DIFTHR_EN = 1552,
	VT_FW_DIFTHR_S_P = 1553,
	VT_FW_DIFTHR_S_R = 1554,
	VT_FW_DIFTHR_S_Y = 1555,
	VT_FW_MIN_ALT = 1556,
	VT_FW_QC_HMAX = 1557,
	VT_FW_QC_P = 1558,
	VT_FW_QC_R = 1559,
	...
	VT_F_TRANS_THR = 1561,
	VT_F_TR_OL_TM = 1562,
	VT_LND_PITCH_MIN = 1563,
	VT_PITCH_MIN = 1564,
	VT_PSHER_SLEW = 1565,
	VT_QC_ALT_LOSS = 1566,
	VT_QC_T_ALT_LOSS = 1567,
	VT_SPOILER_MC_LD = 1568,
	VT_TILT_FW = 1569,
	VT_TILT_MC = 1570,
	VT_TILT_SPINUP = 1571,
	VT_TILT_TRANS = 1572,
	VT_TRANS_MIN_TM = 1573,
	VT_TRANS_P2_DUR = 1574,
	VT_TRANS_TIMEOUT = 1575,
	VT_TYPE = 1576,
	WEIGHT_BASE = 1577,
	WEIGHT_GROSS = 1578,
	WV_EN = 1579,
