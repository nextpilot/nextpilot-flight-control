...
bool Geofence::insidePolygon(const PolygonInfo &polygon, double lat, double lon, float altitude) {
    ...
    for (unsigned i = 0, j = polygon.vertex_count - 1; i < polygon.vertex_count; j = i++) {
        ...
        if (temp_vertex_i.frame != NAV_FRAME_GLOBAL && temp_vertex_i.frame != NAV_FRAME_GLOBAL_INT && temp_vertex_i.frame != NAV_FRAME_GLOBAL_RELATIVE_ALT && temp_vertex_i.frame != NAV_FRAME_GLOBAL_RELATIVE_ALT_INT) {
...
bool Geofence::insideCircle(const PolygonInfo &polygon, double lat, double lon, float altitude) {
    ...
    if (circle_point.frame != NAV_FRAME_GLOBAL && circle_point.frame != NAV_FRAME_GLOBAL_INT && circle_point.frame != NAV_FRAME_GLOBAL_RELATIVE_ALT && circle_point.frame != NAV_FRAME_GLOBAL_RELATIVE_ALT_INT) {
        // TODO: handle different frames
