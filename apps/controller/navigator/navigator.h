...
public:
    ...
    bool home_alt_valid() {
        return (_home_pos.valid_alt);
    }

    bool home_global_position_valid() {
        return (_home_pos.valid_alt && _home_pos.valid_hpos);
    }
     ...
     */
    void set_cruising_throttle(float throttle = NAN) {
    ...
    int mission_instance_count() const {
        return _mission_result.instance_count;
    }
    ...
    bool on_mission_landing() {
        return (_mission.landing() && _navigation_mode == &_mission);
    }
    ...
    int get_mission_landing_index() {
        return _mission.get_land_start_index();
    }
    ...
    float get_mission_landing_loiter_radius() {
        return _mission.get_landing_loiter_rad();
    }
