...
public:
     ...
     */
    void setHadActuatorFailure(bool failure) {
        _had_actuator_failure = failure;
    }
    ...
    int numConfiguredActuators() const {
        return _num_actuators;
    }

    void setNormalizeRPY(bool normalize_rpy) {
        _normalize_rpy = normalize_rpy;
    }
