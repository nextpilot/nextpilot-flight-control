...
public:
    ...
    bool inFailsafe() const {
        return _selected_action != Action::None;
    }
    ...
    bool userTakeoverActive() const {
        return _user_takeover_active;
    }
...
protected:
    ...
    const failsafe_flags_s &lastStatusFlags() const {
        return _last_status_flags;
    }
