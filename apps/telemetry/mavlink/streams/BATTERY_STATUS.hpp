...
private:
    explicit MavlinkStreamBatteryStatus(Mavlink *mavlink) :
    ...
    bool send() override {
        ...
        for (auto &battery_sub : _battery_status_subs) {
            ...
            if (battery_sub.update(&battery_status)) {
                ...
                static constexpr int mavlink_cell_slots_extension = (sizeof(bat_msg.voltages_ext) / sizeof(bat_msg.voltages_ext[0]));
