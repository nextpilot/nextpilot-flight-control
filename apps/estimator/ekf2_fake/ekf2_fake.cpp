...
void EKF2FAKE::publish_cmd_data(const hrt_abstime now_us) {
    ...
    _vctr_mode.flag_control_attitude_enabled             = true;
    ...
    _vstatus.hil_state                    = 0;
    _vstatus.vehicle_type                 = 0;
    _vstatus.failsafe                     = 0;
    ...
    _vstatus.is_vtol                      = 0;
    _vstatus.is_vtol_tailsitter           = 0;
    _vstatus.in_transition_mode           = 0;
    _vstatus.in_transition_to_fw          = 0;
