...
def predict_covariance(
    state: VState, P: MState, d_vel: sf.V3, d_vel_var: sf.V3, d_ang: sf.V3, d_ang_var: sf.Scalar, dt: sf.Scalar
):
...
def compute_airspeed_h_and_k(state: VState, P: MState, innov_var: sf.Scalar, epsilon: sf.Scalar) -> (VState, VState):
...
def compute_sideslip_h_and_k(state: VState, P: MState, innov_var: sf.Scalar, epsilon: sf.Scalar) -> (VState, VState):
...
def compute_mag_y_innov_var_and_h(state: VState, P: MState, R: sf.Scalar, epsilon: sf.Scalar) -> (sf.Scalar, VState):
...
def compute_mag_z_innov_var_and_h(state: VState, P: MState, R: sf.Scalar, epsilon: sf.Scalar) -> (sf.Scalar, VState):
...
def compute_yaw_321_innov_var_and_h(state: VState, P: MState, R: sf.Scalar, epsilon: sf.Scalar) -> (sf.Scalar, VState):
...
def compute_yaw_312_innov_var_and_h(state: VState, P: MState, R: sf.Scalar, epsilon: sf.Scalar) -> (sf.Scalar, VState):
...
def compute_gnss_yaw_pred_innov_var_and_h(
    state: VState, P: MState, antenna_yaw_offset: sf.Scalar, R: sf.Scalar, epsilon: sf.Scalar
) -> (sf.Scalar, sf.Scalar, VState):
...
def predict_drag(state: VState, rho: sf.Scalar, cd: sf.Scalar, cm: sf.Scalar, epsilon: sf.Scalar):
    q_att = sf.V4(state[State.qw], state[State.qx], state[State.qy], state[State.qz])
    R_to_earth = quat_to_rot(q_att)
    R_to_body = R_to_earth.T
...
def compute_drag_x_innov_var_and_k(
    state: VState, P: MState, rho: sf.Scalar, cd: sf.Scalar, cm: sf.Scalar, R: sf.Scalar, epsilon: sf.Scalar
) -> (sf.Scalar, sf.Scalar, VState):
