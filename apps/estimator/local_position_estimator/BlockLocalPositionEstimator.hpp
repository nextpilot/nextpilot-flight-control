...
class BlockLocalPositionEstimator : public ModuleCommand<BlockLocalPositionEstimator>, public ModuleParams, public WorkItem, public control::SuperBlock {
    // dynamics:
    //
    //	x(+) = A * x(-) + B * u(+)
    //	y_i = C_i*x
...
private:
    ...
    DEFINE_PARAMETERS(
        // general parameters
        (ParamInt<params_id::LPE_FUSION>)_param_lpe_fusion,
        (ParamFloat<params_id::LPE_VXY_PUB>)_param_lpe_vxy_pub,
        (ParamFloat<params_id::LPE_Z_PUB>)_param_lpe_z_pub,

        // sonar parameters
        (ParamFloat<params_id::LPE_SNR_Z>)_param_lpe_snr_z,
        (ParamFloat<params_id::LPE_SNR_OFF_Z>)_param_lpe_snr_off_z,

        // lidar parameters
        (ParamFloat<params_id::LPE_LDR_Z>)_param_lpe_ldr_z,
        (ParamFloat<params_id::LPE_LDR_OFF_Z>)_param_lpe_ldr_off_z,

        // accel parameters
        (ParamFloat<params_id::LPE_ACC_XY>)_param_lpe_acc_xy,
        (ParamFloat<params_id::LPE_ACC_Z>)_param_lpe_acc_z,

        // baro parameters
        (ParamFloat<params_id::LPE_BAR_Z>)_param_lpe_bar_z,

        // gps parameters
        (ParamFloat<params_id::LPE_GPS_DELAY>)_param_lpe_gps_delay,
        (ParamFloat<params_id::LPE_GPS_XY>)_param_lpe_gps_xy,
        (ParamFloat<params_id::LPE_GPS_Z>)_param_lpe_gps_z,
        (ParamFloat<params_id::LPE_GPS_VXY>)_param_lpe_gps_vxy,
        (ParamFloat<params_id::LPE_GPS_VZ>)_param_lpe_gps_vz,
        (ParamFloat<params_id::LPE_EPH_MAX>)_param_lpe_eph_max,
        (ParamFloat<params_id::LPE_EPV_MAX>)_param_lpe_epv_max,

        // vision parameters
        (ParamFloat<params_id::LPE_VIS_XY>)_param_lpe_vis_xy,
        (ParamFloat<params_id::LPE_VIS_Z>)_param_lpe_vis_z,
        (ParamFloat<params_id::LPE_VIS_DELAY>)_param_lpe_vis_delay,

        // mocap parameters
        (ParamFloat<params_id::LPE_VIC_P>)_param_lpe_vic_p,

        // flow parameters
        (ParamFloat<params_id::LPE_FLW_OFF_Z>)_param_lpe_flw_off_z,
        (ParamFloat<params_id::LPE_FLW_SCALE>)_param_lpe_flw_scale,
        (ParamInt<params_id::LPE_FLW_QMIN>)_param_lpe_flw_qmin,
        (ParamFloat<params_id::LPE_FLW_R>)_param_lpe_flw_r,
        (ParamFloat<params_id::LPE_FLW_RR>)_param_lpe_flw_rr,

        // land parameters
        (ParamFloat<params_id::LPE_LAND_Z>)_param_lpe_land_z,
        (ParamFloat<params_id::LPE_LAND_VXY>)_param_lpe_land_vxy,

        // process noise
        (ParamFloat<params_id::LPE_PN_P>)_param_lpe_pn_p,
        (ParamFloat<params_id::LPE_PN_V>)_param_lpe_pn_v,
        (ParamFloat<params_id::LPE_PN_B>)_param_lpe_pn_b,
        (ParamFloat<params_id::LPE_PN_T>)_param_lpe_pn_t,
        (ParamFloat<params_id::LPE_T_MAX_GRADE>)_param_lpe_t_max_grade,

        (ParamFloat<params_id::LPE_LT_COV>)_param_lpe_lt_cov,
        (ParamInt<params_id::LTEST_MODE>)_param_ltest_mode,

        // init origin
        (ParamInt<params_id::LPE_FAKE_ORIGIN>)_param_lpe_fake_origin,
        (ParamFloat<params_id::LPE_LAT>)_param_lpe_lat,
        (ParamFloat<params_id::LPE_LON>)_param_lpe_lon)
};
