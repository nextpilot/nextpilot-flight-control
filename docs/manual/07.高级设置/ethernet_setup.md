...
PX4 uses the [netman]#netman) module to apply and update network settings.
...
| ------------------------------------------------------------------------------ | ------ | ------------------------------------------------------------ |
| [MAV_2_CONFIG](../19.高级调参/parameter_reference.md#MAV_2_CONFIG)         | 1000   | Configure Ethernet port                                      |
| [MAV_2_BROADCAST](../19.高级调参/parameter_reference.md#MAV_2_BROADCAST)   | 1      | Broadcast `HEARTBEAT` messages                               |
| [MAV_2_MODE](../19.高级调参/parameter_reference.md#MAV_2_MODE)             | 0      | Send the "normal" set of MAVLink messages (i.e. the GCS set) |
| [MAV_2_RADIO_CTL](../19.高级调参/parameter_reference.md#MAV_2_RADIO_CTL)   | 0      | Disable software throttling of MAVLink traffic               |
| [MAV_2_RATE](../19.高级调参/parameter_reference.md#MAV_2_RATE)             | 100000 | Maximum sending rate                                         |
| [MAV_2_REMOTE_PRT](../19.高级调参/parameter_reference.md#MAV_2_REMOTE_PRT) | 14550  | MAVLink Remote Port of 14550 (GCS)                           |
| [MAV_2_UDP_PRT](../19.高级调参/parameter_reference.md#MAV_2_UDP_PRT)       | 14550  | MAVLink Network Port of 14550 (GCS)                          |
...
You can configure this setup by changing [MAV_2_REMOTE_PRT](../19.高级调参/parameter_reference.md#MAV_2_REMOTE_PRT) and [MAV_2_UDP_PRT](../19.高级调参/parameter_reference.md#MAV_2_UDP_PRT) to `14540` and [MAV_2_MODE](../19.高级调参/parameter_reference.md#MAV_2_MODE) to `2` (Onboard).
...
1. Modify the [PX4 Ethernet Port Configuration](#px4-ethernet-network-setup) to connect to a companion computer.
   You might change the parameters [MAV_2_REMOTE_PRT](../19.高级调参/parameter_reference.md#MAV_2_REMOTE_PRT) and [MAV_2_UDP_PRT](../19.高级调参/parameter_reference.md#MAV_2_UDP_PRT) to `14540`, and [MAV_2_MODE](../19.高级调参/parameter_reference.md#MAV_2_MODE) to `2` (Onboard).
...
- You have a supported autopilot hardware running PX4 firmware that includes [uXRCE-DDS](../middleware/uxrce_dds.md) middleware.
  Note that PX4 v1.14 and later include the required [uxrce_dds_client]#uxrce-dds-client) module by default.
...
4. Run a [listener node]#running-the-example) in a new terminal to confirm the connection is established:
