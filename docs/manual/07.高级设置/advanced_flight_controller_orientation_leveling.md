...
The [SENS_BOARD_ROT](../19.高级调参/parameter_reference.md#SENS_BOARD_ROT) parameter defines the rotation of the flight controller board relative to the vehicle frame, while the fine tuning offsets ([SENS_BOARD_X_OFF](../19.高级调参/parameter_reference.md#SENS_BOARD_X_OFF), [SENS_BOARD_Y_OFF](../19.高级调参/parameter_reference.md#SENS_BOARD_Y_OFF), [SENS_BOARD_Z_OFF](../19.高级调参/parameter_reference.md#SENS_BOARD_Z_OFF)) set the rotation of the sensors relative to the board itself.
...
First perform the normal calibration for [Flight Controller Orientation](../07.标准配置/05.flight_controller_orientation.md) and [Level Horizon Calibration](../07.标准配置/11.level_horizon_calibration.md) to set the [SENS_BOARD_ROT](../19.高级调参/parameter_reference.md#SENS_BOARD_ROT) parameter.
...
- [SENS_BOARD_ROT](../19.高级调参/parameter_reference.md#SENS_BOARD_ROT): Rotation of the FMU board relative to the vehicle frame.
- [SENS_BOARD_X_OFF](../19.高级调参/parameter_reference.md#SENS_BOARD_X_OFF): Rotation, in degrees, around PX4FMU's X axis or Roll axis.
  Positive angles increase in CCW direction, negative angles increase in CW direction.
- [SENS_BOARD_Y_OFF](../19.高级调参/parameter_reference.md#SENS_BOARD_Y_OFF): Rotation, in degrees, around PX4FMU's Y axis or Pitch axis.
  Positive angles increase in CCW direction, negative angles increase in CW direction.
- [SENS_BOARD_Z_OFF](../19.高级调参/parameter_reference.md#SENS_BOARD_Z_OFF): Rotation, in degrees, around PX4FMU's Z axis Yaw axis.
  Positive angles increase in CCW direction, negative angles increase in CW direction.
