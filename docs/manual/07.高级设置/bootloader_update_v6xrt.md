...
This topic explains explains to flash Pixhawk FMUv6X-RT bootloader via USB _without needing a debug probe_.
...
Most flight controllers require a Debug probe in order to update the bootloader, as discussed in [Bootloader Update > Debug Probe Bootloader Update](../19.高级调参/bootloader_update.md#debug-probe-bootloader-update).
