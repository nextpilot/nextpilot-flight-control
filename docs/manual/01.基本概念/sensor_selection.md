...
The minimal set of sensors is incorporated into Pixhawk Series flight controllers (and may also be in other controller platforms).
...
- [GPS/Compass](../21.周边设备/04.传 感 器/01.卫星导航/ub482.md)
- RTK GNSS (GPS)
...
For more information and recommended hardware see: [Airspeed Sensors](../21.周边设备/04.传 感 器/15.空速计/airspeed.md).
...
For more information see: Distance Sensors.

<img src="/assets/hardware/sensors/lidar_lite/lidar_lite_1.png" title="lidar_lite_1" width="500px" />

## Optical Flow

Optical Flow sensors use a downward facing camera and a downward facing distance sensor for velocity estimation.
...
- Peripheral Hardware contains documentation for other sensors, such as [Battery/Power Monitors](../21.周边设备/12.电源模块/README.md)), Air traffic warning systems, Tachometers.
