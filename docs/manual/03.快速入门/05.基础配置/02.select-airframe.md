...
After installing firmware you need to select the [vehicle type and specific frame configuration](../../09.机型调参/01.airframe_reference.md) that best matches your vehicle frame.
...
[Actuator Configuration & Testing](./actuators.md) shows how to set the precise geometry of the vehicle motors and actuators, and their mapping to flight controller outputs.
After mapping actuators to outputs you should perform [ESC Calibration](../19.高级调参/esc_calibration.md) if using PWM or OneShot ESCs.
