...
::: info
These instructions require that the vehicle has a Power Module (PM(../21.周边设备/12.电源模块/README.md), or other hardware that can measure the battery voltage and (optionally) the current.
...
All battery calibration parameters [are listed here](../19.高级调参/parameter_reference.md#battery-calibration).
:::
...
For vehicles with multiple batteries you'll need to directly [set the parameters](../19.高级调参/parameters.md) for battery 2 (`BAT2_*`), as described in the following sections.
:::
...
::: info
This setting corresponds to [parameters](../19.高级调参/parameters.md): [BAT1_N_CELLS](../19.高级调参/parameter_reference.md#BAT1_N_CELLS) and [BAT2_N_CELLS](../19.高级调参/parameter_reference.md#BAT2_N_CELLS).
:::
...
::: info
This setting corresponds to [parameters](../19.高级调参/parameters.md): [BAT1_V_CHARGED](../19.高级调参/parameter_reference.md#BAT1_V_CHARGED) and [BAT2_V_CHARGED](../19.高级调参/parameter_reference.md#BAT2_V_CHARGED).
:::
...
::: info
This setting corresponds to [parameter](../19.高级调参/parameters.md): [BAT1_V_EMPTY](../19.高级调参/parameter_reference.md#BAT1_V_EMPTY) and [BAT2_V_EMPTY](../19.高级调参/parameter_reference.md#BAT2_V_EMPTY).
:::
...
::: info
This setting corresponds to parameters: [BAT1_V_DIV](../19.高级调参/parameter_reference.md#BAT1_V_DIV) and [BAT2_V_DIV](../19.高级调参/parameter_reference.md#BAT2_V_DIV).
:::
...
::: info
This setting corresponds to parameter(s): [BAT1_A_PER_V](../19.高级调参/parameter_reference.md#BAT1_A_PER_V) and [BAT2_A_PER_V](../19.高级调参/parameter_reference.md#BAT2_A_PER_V).
:::
...
::: info
To use the load compensation you will still need to set the [basic configuration](#basic_settings). The _Empty Voltage_ ([BAT_V_EMPTY](../19.高级调参/parameter_reference.md#BAT_V_EMPTY)) should be set higher (than without compensation) because the compensated voltage gets used for the estimation (typically set a bit below the expected rest cell voltage when empty after use).
:::

PX4 supports two load compensation methods, which are enabled by [setting](../19.高级调参/parameters.md) either of the two parameters below:

- [BAT1_R_INTERNAL](../19.高级调参/parameter_reference.md#BAT1_R_INTERNAL) - [Current-based Load Compensation](#current_based_load_compensation) (recommended).
- [BAT1_V_LOAD_DROP](../19.高级调参/parameter_reference.md#BAT1_V_LOAD_DROP) - [Thrust-based Load Compensation](#thrust_based_load_compensation).
...
1. Set the parameter [BAT1_R_INTERNAL](../19.高级调参/parameter_reference.md#BAT1_R_INTERNAL) to the internal resistance of battery 1 (and repeat for other batteries).
...
1. Set the parameter [BAT1_V_LOAD_DROP](../19.高级调参/parameter_reference.md#BAT1_V_LOAD_DROP) to how much voltage drop a cell shows under the load of full throttle.
...
1. Set the parameter [BAT1_CAPACITY](../19.高级调参/parameter_reference.md#BAT1_CAPACITY) to around 90% of the advertised battery capacity (usually printed on the battery label).
