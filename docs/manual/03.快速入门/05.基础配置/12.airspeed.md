...
!!! info
   [Airspeed sensors](../21.周边设备/04.传 感 器/15.空速计/airspeed.md) are highly recommended for Fixed-wing and VTOL vehicles.

!!! warning
   Unlike most other sensor drivers, the airspeed sensor drivers are not automatically started.
   Before calibration they must be [enabled via the corresponding parameter](../19.高级调参/parameters.md):
