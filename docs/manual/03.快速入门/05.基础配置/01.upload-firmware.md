...
_QGroundControl_ **desktop** versions can be used to install PX4 firmware onto [Pixhawk-series](../01.基本概念/flight_controller_selection.md) flight-controller boards.
...
Next you will need to specify the [vehicle airframe](./02.select-airframe.md) (and then sensors, radio, etc.)
...
You can update it by following the instructions in [Bootloader update > FMUv2 Bootloader Update](../19.高级调参/bootloader_update.md#fmuv2-bootloader-update).
