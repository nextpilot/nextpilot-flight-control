...
Otherwise it should not need to recalibrated (except perhaps in winter, if the flight controller was not [thermally calibrated](../19.高级调参/sensor_thermal_calibration.md) in the factory).
...
:::tip
This is similar to [compass calibration](./06.compass.md) except that you hold the vehicle still (rather than rotate it) in each orientation.
:::
...
1. Click the **Accelerometer** sensor button.
   ...
   ::: info
   You should already have set the [Autopilot Orientation](./05.flight_controller_orientation.md).
