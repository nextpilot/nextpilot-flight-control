...
This topic explains how to map [flight modes](../01.基本概念/basic_concepts.md#flight-modes) and other functions to the switches on your radio control transmitter.

:::tip
In order to set up flight modes you must already have:

- [Configured your radio](./radio.md)
...
You can set any (or none) of the flight modes [available to your vehicle](../05.基本概念/01.飞行模式/index.md#flight-modes).
...
- <a id="kill_switch"></a> [Kill Switch](./99.safety.md#kill-switch) - Immediately stops all motor outputs (the vehicle will crash, which may in some circumstances be more desirable than allowing it to continue flying).
...
- [Flight Modes Overview](../05.基本概念/01.飞行模式/index.md)
...
- [Radio switch parameters](../19.高级调参/parameter_reference.md#radio-switches) - Can be used to set mappings via parameters
