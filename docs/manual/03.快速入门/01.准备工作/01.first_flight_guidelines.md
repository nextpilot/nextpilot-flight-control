...
[Learning to fly](../03.飞行指南/basic_flying.md) is a lot of fun!
...
::: info
It can be useful to [set a safety switch on your transmitter](../07.标准配置/99.safety.md#emergency-switches).
