...
:::tip
*Stabilized mode* is much easier to fly than [Manual mode](../05.基本概念/01.飞行模式/manual_fw.md) because you can't roll or flip it, and it is easy to level the vehicle by centering the control sticks.
:::
