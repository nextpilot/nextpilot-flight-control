...
[<img src="/assets/site/difficulty_easy.png" title="Easy to fly" width="30px" />](../README.md#key_difficulty)&nbsp;[<img src="/assets/site/position_fixed.svg" title="Position fix required (e.g. GPS)" width="30px" />](../README.md#key_position_fixed)
...
* **Left stick:**
  * *up/down:* controls speed of ascent/descent, as in [Position mode](../05.基本概念/01.飞行模式/position_mc.md). When in center deadzone, altitude is locked.
