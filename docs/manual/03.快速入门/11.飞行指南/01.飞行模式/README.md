...
:::tip
A *beginner friendly* explanation of all flight modes is provided in [Getting Started > Flight Modes](../README.md).
:::
...
VTOL supports [Offboard](../05.基本概念/01.飞行模式/offboard.md) mode in either configuration.
