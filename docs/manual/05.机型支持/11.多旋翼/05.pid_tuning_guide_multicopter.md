...
:::tip
[Autotune](../07.标准配置/98.autotune.md) is recommended for tuning the vehicles _around the hover thrust point_, as the approach described is intuitive, easy, and fast.
...
- Optionally enable the high-rate logging profile with the [SDLOG_PROFILE](../19.高级调参/parameter_reference.md#SDLOG_PROFILE) parameter so you can use the log to evaluate the rate and attitude tracking performance (the option can be disabled afterwards).

:::warning
Always disable [MC_AIRMODE](../19.高级调参/parameter_reference.md#MC_AIRMODE) when tuning a vehicle.
:::
...
A badly tuned rate controller will be visible in [Position mode](../05.基本概念/01.飞行模式/position.md), for example, as "twitches" (the vehicle will not hold perfectly still in the air).
:::
...
- Roll rate control ([MC_ROLLRATE_P](../19.高级调参/parameter_reference.md#MC_ROLLRATE_P), [MC_ROLLRATE_I](../19.高级调参/parameter_reference.md#MC_ROLLRATE_I), [MC_ROLLRATE_D](../19.高级调参/parameter_reference.md#MC_ROLLRATE_D), [MC_ROLLRATE_K](../19.高级调参/parameter_reference.md#MC_ROLLRATE_K))
- Pitch rate control ([MC_PITCHRATE_P](../19.高级调参/parameter_reference.md#MC_PITCHRATE_P), [MC_PITCHRATE_I](../19.高级调参/parameter_reference.md#MC_PITCHRATE_I), [MC_PITCHRATE_D](../19.高级调参/parameter_reference.md#MC_PITCHRATE_D), [MC_PITCHRATE_K](../19.高级调参/parameter_reference.md#MC_PITCHRATE_K))
- Yaw rate control ([MC_YAWRATE_P](../19.高级调参/parameter_reference.md#MC_YAWRATE_P), [MC_YAWRATE_I](../19.高级调参/parameter_reference.md#MC_YAWRATE_I), [MC_YAWRATE_D](../19.高级调参/parameter_reference.md#MC_YAWRATE_D), [MC_YAWRATE_K](../19.高级调参/parameter_reference.md#MC_YAWRATE_K))

The rate controller can be tuned in [Acro mode](../05.基本概念/01.飞行模式/acro.md) or [Manual/Stabilized mode](../05.基本概念/01.飞行模式/manual_stabilized.md):
...
- Roll control ([MC_ROLL_P](../19.高级调参/parameter_reference.md#MC_ROLL_P))
- Pitch control ([MC_PITCH_P](../19.高级调参/parameter_reference.md#MC_PITCH_P))
- Yaw control ([MC_YAW_P](../19.高级调参/parameter_reference.md#MC_YAW_P))
...
- Maximum roll rate ([MC_ROLLRATE_MAX](../19.高级调参/parameter_reference.md#MC_ROLLRATE_MAX))
- Maximum pitch rate ([MC_PITCHRATE_MAX](../19.高级调参/parameter_reference.md#MC_PITCHRATE_MAX))
- Maximum yaw rate ([MC_YAWRATE_MAX](../19.高级调参/parameter_reference.md#MC_YAWRATE_MAX))
...
To counteract that, adjust the **thrust curve** with the [THR_MDL_FAC](../19.高级调参/parameter_reference.md#THR_MDL_FAC) parameter.
...
Note that this is the equation that is used in the firmware to map thrust and motor command, as shown in the [THR_MDL_FAC](../19.高级调参/parameter_reference.md#THR_MDL_FAC) parameter reference.
...
Once your vehicle flies well you can enable Airmode via the [MC_AIRMODE](../19.高级调参/parameter_reference.md#MC_AIRMODE) parameter.
