...
* Pixhawk Mini (Discontinued(../01.基本概念/pixhawk_mini.md)
  * 3DR 10S Power Module
  * 3DR 433MHz Telemetry Module (EU)
* [Spektrum Dxe Controller](https://www.spektrumrc.com/Products/Default.aspx?ProdId=SPM1000) or other PX4-compatible remotes
* [Spektrum Quad Race Serial Receiver w/Diversity](https://www.spektrumrc.com/Products/Default.aspx?ProdID=SPM4648)
* [PX4Flow](../21.周边设备/04.传 感 器/px4flow.md) (Deprecated)
...
::: info
As documented in the Airframe Reference: Generic ground vehicle (Ackermann(../09.机型调参/01.airframe_reference.md#rover_rover_generic_ground_vehicle_(ackermann)).
:::
...
1. Switch to the [Basic Configuration](../07.标准配置/index.md) section in *QGroundControl*
