...
Therefore a low-weight flight controller is recommended (e.g. [Holybro pix32](../01.基本概念/holybro_pix32.md) or [CUAV nano](../01.基本概念/cuav_v5_nano.md)).
...
* Autopilot ([Holybro pix32](../01.基本概念/holybro_pix32.md), [CUAV nano](../01.基本概念/cuav_v5_nano.md))
