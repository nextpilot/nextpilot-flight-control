...
:::warning
Support for autogyro frames is [experimental](../01.airframe_reference.md#experimental-vehicles).
...
The set of supported configurations can be seen in [Airframes Reference > Autogyro](../09.机型调参/01.airframe_reference.md#autogyro).
