...
* [Pixracer autopilot board + power module](../01.基本概念/pixracer.md)
...
Switch to the configuration section in [QGroundControl](../07.标准配置/02.select-airframe.md) and select the airframe tab. 
