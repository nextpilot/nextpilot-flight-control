...
The supported set is listed in [Airframes Reference > VTOL](../09.机型调参/01.airframe_reference.md#vtol).
...
The flight modes for VTOL vehicles are the same as for [multicopter](../05.基本概念/01.飞行模式/index.md) when flying in MC mode and [fixed-wing](../05.基本概念/01.飞行模式/index.md) when flying in FW mode.
...
The mapping between flight controller outputs and specific controls/motors depends on the vehicle frame used, and is specified in the [Airframes Reference > VTOL](../09.机型调参/01.airframe_reference.md#vtol).

Assembly information is covered in several sections:

- [Basic Assembly](../02.快速入门/03.设备安装/index.md) contains topics shows the setup of core components for a number of popular [flight controllers](../01.基本概念/index.md).
...
- [Peripherals](../21.周边设备/index.md) contains information about other peripherals, including [Airspeed Sensors](../21.周边设备/04.传 感 器/airspeed.md).
- [Airframes Reference > VTOL](../09.机型调参/01.airframe_reference.md#vtol) explains which flight controller outputs must be connected to different flight controls for each airframe configuration:
...
For example see [FunCub QuadPlane](../09.机型调参/frames_vtol/vtol_quadplane_fun_cub_vtol_pixhawk.md).

## Configuration

VTOL configuration is covered in a number of sections:

- [Basic Configuration](../07.标准配置/index.md) - Configuration that is common to all vehicle types (sensors, safety systems, batteries etc).
- [VTOL Specific Configuration](../config_vtol/index.md)
- [Peripheral Hardware](../21.周边设备/index.md) - Configuration for optional hardware and sensors.
- [Advanced Configuration](../19.高级调参/index.md): Additional configuration covering factory tuning and advanced and optional configuration.
...
[TBS Caipiroshka](../09.机型调参/frames_vtol/vtol_tailsitter_caipiroshka_pixracer.md)

@[youtube](https://www.youtube.com/watch?v=acG0aTuf3f8&vq=hd720)

### Tiltrotor

[Convergence Tiltrotor](../09.机型调参/frames_vtol/vtol_tiltrotor_eflite_convergence_pixfalcon.md)

@[youtube](https://youtu.be/E61P2f2WPNU)

### QuadPlane VTOL

[FunCub QuadPlane](../09.机型调参/frames_vtol/vtol_quadplane_fun_cub_vtol_pixhawk.md)

@[youtube](https://www.youtube.com/watch?v=4K8yaa6A0ks&vq=hd720)

[Falcon Vertigo QuadPlane](../09.机型调参/frames_vtol/vtol_quadplane_falcon_vertigo_hybrid_rtf_dropix.md)

@[youtube](https://youtu.be/h7OHTigtU0s)

[Ranger QuadPlane](../09.机型调参/frames_vtol/vtol_quadplane_volantex_ranger_ex_pixhawk.md)
