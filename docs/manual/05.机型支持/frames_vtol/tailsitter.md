...
Tailsitters are typically mechanically less complex than [other types of VTOL](../09.机型调参/frames_vtol/index.md), and hence may be less expensive to build and maintain.
...
VTOL setup and flying are covered in the [VTOL](../09.机型调参/frames_vtol/index.md) parent topic.
...
- TBS Caipiroshka Tailsitter Build (Pixracer(../09.机型调参/frames_vtol/vtol_tailsitter_caipiroshka_pixracer.md)
...
This section contains videos that are specific to Tailsitter VTOL (videos that apply to all VTOL types can be found in [VTOL](../09.机型调参/frames_vtol/index.md)).

### Duo

---

[TBS Caipiroshka](../09.机型调参/frames_vtol/vtol_tailsitter_caipiroshka_pixracer.md) - Tailsitter takeoff (close up), hover, level flight, transitions. 

@[youtube](https://www.youtube.com/watch?v=acG0aTuf3f8&vq=hd720)

---

[Woshark](https://uav-cas.ac.cn/WOSHARK/) *PX4 Tailsitter prototype* - Tailsitter takeoff, transition, landing. 
...
<div class="grid_wrapper three_column">
  ...
  <div class="grid_item">
    <div class="grid_item_heading"><big><a href="https://uav-cas.ac.cn/WOSHARK/">Woshark</a></big></div>
    <div class="grid_text">
