...
The weather vane feature will only take effect in [Position mode](../05.基本概念/01.飞行模式/position.md) (not other manual MC modes).
...
This functionality is configured using the [WV\_\* parameters](../19.高级调参/parameter_reference.md#WV_EN).

| Parameter                                                              | Description                                                                  |
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| [WV_EN](../19.高级调参/parameter_reference.md#WV_EN)               | Enable weather vane.                                                         |
| [WV_ROLL_MIN](../19.高级调参/parameter_reference.md#WV_ROLL_MIN)   | Minimum roll angle setpoint for weathervane controller to demand a yaw-rate. |
| [WV_YRATE_MAX](../19.高级调参/parameter_reference.md#WV_YRATE_MAX) | Maximum yawrate the weathervane controller is allowed to demand.             |
