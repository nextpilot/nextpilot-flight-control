...
The vehicle will then match the configuration documented in the [Airframe Reference](../09.机型调参/01.airframe_reference.md#vectored-6-dof-uuv):
...
1. [Install PX4 Firmware](../07.标准配置/01.upload-firmware.md#installing-px4-main-beta-or-custom-firmware)
1. [Set the Airframe](../07.标准配置/02.select-airframe.md).
