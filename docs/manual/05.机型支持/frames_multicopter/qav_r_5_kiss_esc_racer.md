...
- **Flight controller:** [Pixracer](../01.基本概念/pixracer.md)
...
* Autopilot: [Pixracer](../01.基本概念/pixracer.md) from [AUAV](https://store.mrobotics.io/mRo-PixRacer-R14-Official-p/auav-pxrcr-r14-mr.htm) including ESP8266  WiFi- and [ACSP5](https://store.mrobotics.io/product-p/auav-acsp5-mr.htm)  power-module
* Frame:  [Lumenier QAV-R 5"](https://www.getfpv.com/qav-r-fpv-racing-quadcopter-5.html)
...
* GPS / Ext. Mag.: M8N taken from a Pixhawk Mini (Discontinued(../01.基本概念/pixhawk_mini.md) set and rewired
...
You'll need the [hardware documentation of the Pixracer](../01.基本概念/pixracer.md) for this step to find all needed connectors.
...
For the ESC signals I followed the [hardware documentation of the Pixracer](../01.基本概念/pixracer.md) and the [Quadrotor x configuration](../09.机型调参/01.airframe_reference.md#quadrotor-x) motor numbering scheme.
...
Sadly the pin assignment was completely wrong and I rewired the connector again using tweezers according to the [3DR Pixhawk Mini user manual](../01.基本概念/pixhawk_mini.md#connector-pin-assignments-pin-outs) GPS port.
...
[Download and install](https://qgroundcontrol.com/downloads/) *QGroundControl* for your platform.

:::tip
Full instructions for installing and configuring PX4 can be found in [Basic Configuration](../07.标准配置/index.md).
:::
...
- [Firmware](../07.标准配置/01.upload-firmware.md)
- [Airframe](../07.标准配置/02.select-airframe.md)
...
- [Actuators](../07.标准配置/actuators.md)
...
* [Level Horizon Calibration](../07.标准配置/11.level_horizon_calibration.md)
* [Radio Setup](../07.标准配置/radio.md)
* [Flight Modes](../07.标准配置/flight_mode.md)

Ideally you should also do:

- [ESC Calibration](../19.高级调参/esc_calibration.md)
- [Battery Estimation Tuning](../07.标准配置/battery.md)
  - 4S (4 cell LiPo) with charged cell voltage 4.15V and empty cell voltage 3.5V (or appropriate values for your battery).
- [Safety](../07.标准配置/99.safety.md)
...
For instructions on how, start from [Autotune](../07.标准配置/98.autotune.md).
