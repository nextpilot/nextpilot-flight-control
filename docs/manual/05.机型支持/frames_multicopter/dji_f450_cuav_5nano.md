...
- **Frame:** DJI F450
- **Flight controller:** [CUAV V5 nano](../01.基本概念/cuav_v5_nano.md)
...
1. Plug in Telemetry (`TELEM1`), GPS module (`GPS/SAFETY`), RC receiver (`RC`), all 4 ESC’s (`M1-M4`), and the power module (`Power1`) into the flight controller.
   ...
   ::: info
   The motor order is defined in the [Airframe Reference > Quadrotor x](../09.机型调参/01.airframe_reference.md#quadrotor-x)
   :::
