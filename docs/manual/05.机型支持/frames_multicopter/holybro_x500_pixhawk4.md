...
::: info
Holybro initially supplied this kit with a [Holybro Pixhawk 4](../01.基本概念/pixhawk4.md)), but at time of writing this has been upgraded to a [Holybro Pixhawk 6C](../01.基本概念/pixhawk6c.md).
...
- **Flight controller:** [Pixhawk 4](../01.基本概念/pixhawk4.md)
...
* [Pixhawk 4 autopilot](../01.基本概念/pixhawk4.md)
* [Holybro M8N GPS](https://holybro.com/collections/gps/products/m8n-gps)
* [Power Management - PM07](../21.周边设备/12.电源模块/holybro_pm07_pixhawk4_power_module.md)
...
Additionally you will need a battery and receiver ([compatible radio system](../21.周边设备/01.遥 控 器/index.md)) if you want to control the drone manually.
...
Please refer to [Pixhawk 4 Quick Start](../02.快速入门/03.设备安装/quick_start_pixhawk4.md) for more information.
