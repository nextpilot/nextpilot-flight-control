...
::: info
Holybro initially supplied this kit with a [Pixhawk 5X](../01.基本概念/pixhawk5x.md), but at time of writing this has been upgraded to a [Holybro Pixhawk 6C](../01.基本概念/pixhawk6c.md).
...
- **Flight controller:** [Pixhawk 5X](../01.基本概念/pixhawk5x.md)
...
* [Pixhawk 5X autopilot](../01.基本概念/pixhawk5x.md)
* [M8N GPS](https://holybro.com/products/m8n-gps)
* [Power Module - PM02D](../21.周边设备/12.电源模块/holybro_pm02d.md)
* 433/915 MHz Telemetry Radio

Additionally you will need a battery (Holybro recommends a 4S 5000mAh) and receiver ([compatible radio system](../21.周边设备/01.遥 控 器/index.md)) if you want to control the drone manually.
...
Please refer to [Pixhawk 5X Quick Start](../02.快速入门/03.设备安装/quick_start_pixhawk5x.md) for more information.
