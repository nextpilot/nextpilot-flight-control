...
- Electronics:
  - Flight controller: [Holybro KakuteH7](../01.基本概念/kakuteh7.md)
...
- Use an [arming switch](../19.高级调参/prearm_arm_disarm.md#arming-button-switch), do not use stick arming
- [Select DShot](../07.标准配置/actuators.md) as output protocol on all eight outputs
...
- Parameters:
  - Change the desaturation logic for better attitude tracking: set [CA_METHOD](../19.高级调参/parameter_reference.md#CA_METHOD) to 0.
  - Disable failure detection: set [FD_FAIL_P](../19.高级调参/parameter_reference.md#FD_FAIL_P) and [FD_FAIL_R](../19.高级调参/parameter_reference.md#FD_FAIL_R) to 0.
