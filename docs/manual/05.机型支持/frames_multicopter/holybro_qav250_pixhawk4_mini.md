...
- **Flight controller:** [Pixhawk 4 Mini](../01.基本概念/pixhawk4_mini.md)
...
The "basic" frame build is now complete (though if you need them, you can find more information about connecting components in the [Pixhawk 4 Wiring Quickstart](../02.快速入门/03.设备安装/quick_start_pixhawk4.md)). 
