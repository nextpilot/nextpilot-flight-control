...
:::warning
Support for helicopters is [experimental](../01.airframe_reference.md#experimental-vehicles).
...
The allowed flight operations and [flight modes](../05.基本概念/01.飞行模式/index.md) are the same as for multicopter.
...
This is covered in [Basic Assembly](../02.快速入门/03.设备安装/index.md).
...
- [Standard Configuration](../07.标准配置/index.md): The common configuration and calibration steps for most frames.
