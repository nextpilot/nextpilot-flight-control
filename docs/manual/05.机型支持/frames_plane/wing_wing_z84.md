...
It is small, rugged and just large enough to host a [Pixracer](../01.基本概念/pixracer.md).
...
- [Pixracer](../01.基本概念/pixracer.md) kit (including GPS and power module)
- FrSky D4R-II receiver or equivalent (jumpered to PPM sum output according to its manual)
- [Mini telemetry set](../01.基本概念/pixfalcon.md#availability) for Holybro pix32
- [Digital airspeed sensor](../01.基本概念/pixfalcon.md#availability) for Holybro pix32 / Pixfalcon
...
Select **Flying Wing > Generic Flying Wing** in the QGroundControl [Airframe Configuration](../07.标准配置/02.select-airframe.md): 

![QGC - select firmware for West Wing](../../assets/airframes/fw/wing_wing/qgc_firmware_flying_wing_west_wing.png) 

### Actuator Mapping

Set up the [Actuator Configuration](../07.标准配置/actuators.md) to match the wiring for the ailerons and throttle as [indicated above](#wiring).

![QGC - set the actuators](../../assets/airframes/fw/wing_wing/qgc_actuator_config.png)

### Other Configuration

Perform all the the other [Basic Configuration](../07.标准配置/index.md), including [Autotuning](../07.标准配置/98.autotune.md).

Advanced tuning is optional - see [Fixed-wing Vehicle Configuration](../09.机型调参/12.固定翼/index.md).
