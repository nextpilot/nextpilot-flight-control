...
- [Pixhawk 4 Mini](../01.基本概念/pixhawk4_mini.md) (with GPS and Power module)
...
An [airspeed sensor](../21.周边设备/04.传 感 器/airspeed.md) is highly recommended for use on fixed-wing vehicles.
...
The [Acutator Configuration](../07.标准配置/actuators.md) screen is shown below.
...
A custom cable was made to connect the ExpressLRS RX ([RC Reciever](../21.周边设备/01.遥 控 器/index.md)) to the Pixhawk 4 Mini.
...
PX4 is easily capable of stabilizing the airplane and fine tuning of the rate loops were accomplished using [fixed-wing autotuning](../07.标准配置/98.autotune.md).
