...
:::tip
PX4 can also be manually controlled using a [Joystick](../07.标准配置/joystick.md) or gamepad-like controller:  this is different to an RC system!
The [COM_RC_IN_MODE](../19.高级调参/parameter_reference.md#COM_RC_IN_MODE) parameter [can be set](../19.高级调参/parameters.md) to choose whether RC (default), Joystick, both, or neither, are enabled.
:::
...
The remote has physical controls that can be used to specify vehicle movement (e.g. speed, direction, throttle, yaw, pitch, roll, etc.) and to enable autopilot [flight modes](../05.基本概念/01.飞行模式/README.md) (e.g. takeoff, land, return to land, mission etc.).
...
Ground vehicles need at least two channels (steering + throttle). An 8 or 16 channel transmitter provides additional channels that can be used to control other mechanisms or activate different [flight modes](../05.基本概念/01.飞行模式/README.md) provided by the autopilot.
...
:::note
This remote control unit can display vehicle telemetry when used with [FrSky](../21.周边设备/frsky_telemetry.md) or [TBS Crossfire](../telemetry/crsf_telemetry.md) radio modules.
:::
...
* PPM receivers that have an individual wire for each channel must connect to the RCIN channel *via* a PPM encoder [like this one](https://www.getfpv.com/radios/radio-accessories/holybro-ppm-encoder-module.html) (PPM-Sum receivers use a single signal wire for all channels).

Instructions for connecting to specific flight controllers are given in their [quick-start](../02.快速入门/03.设备安装/README.md) guides (such as [CUAV Pixhawk V6X Wiring Quick Start: Radio Control](../02.快速入门/03.设备安装/quick_start_cuav_pixhawk_v6x.md#radio-control) or [Holybro Pixhawk 6X Wiring Quick Start: Radio Control](../02.快速入门/03.设备安装/quick_start_pixhawk6x.md#radio-control)).
...
If you are using a *Spektrum* receiver, you can put it into bind mode using *QGroundControl*: [Radio Setup > Spectrum Bind](../07.标准配置/radio.md#spectrum-bind).

## Set Signal-Loss Behaviour

RC receivers have different ways of indicating signal loss:
* Output nothing (automatically detected by PX4)
* Output a low throttle value (you can [configure PX4 to detect this](../07.标准配置/radio.md#rc-loss-detection)).
...
For more information see [Radio Control Setup > RC Loss Detection](../07.标准配置/radio.md#rc-loss-detection).

## Related Topics

* [Radio Control Setup](../07.标准配置/radio.md) - Configuring your radio with PX4.
* [Manual Flying](../03.飞行指南/basic_flying.md) - Learn how to fly with a remote control.
* [TBS Crossfire (CRSF) Telemetry](../telemetry/crsf_telemetry.md)
* [FrSky Telemetry](../21.周边设备/frsky_telemetry.md)
