...
Enable each type using its [corresponding parameter](../../19.高级调参/parameters.md):

- **Sensirion SDP3X:** [SENS_EN_SDP3X](../../19.高级调参/parameter_reference.md#SENS_EN_SDP3X)
- **TE MS4525:** [SENS_EN_MS4525DO](../../19.高级调参/parameter_reference.md#SENS_EN_MS4525DO)
- **TE MS5525:** [SENS_EN_MS5525DS](../../19.高级调参/parameter_reference.md#SENS_EN_MS5525DS)
- **Eagle Tree airspeed sensor:** [SENS_EN_ETSASPD](../../19.高级调参/parameter_reference.md#SENS_EN_ETSASPD)

You should also check [ASPD_PRIMARY](../../19.高级调参/parameter_reference.md#ASPD_PRIMARY) is `1` (see next section - this is the default).
...
If you have multiple airspeed sensors then you can select which sensor is _preferred_ as the primary source using [ASPD_PRIMARY](../../19.高级调参/parameter_reference.md#ASPD_PRIMARY), where `1`, `2` and `3` reflect the order in which the airspeed sensors were started:
...
The airspeed selector validates the indicated sensor _first_ and only falls back to other sensors if the indicated sensor fails airspeed checks ([ASPD_DO_CHECKS](../../19.高级调参/parameter_reference.md#ASPD_DO_CHECKS) is used to configure the checks).

The selected sensor is then used to supply data to the estimator (EKF2(../../19.高级调参/tuning_the_ecl_ekf.md#airspeed) and the controllers.
...
- **Sensirion SDP3X:** [CAL_AIR_CMODEL](../../19.高级调参/parameter_reference.md#CAL_AIR_CMODEL) (provides overview of required settings), [CAL_AIR_TUBED_MM](../../19.高级调参/parameter_reference.md#CAL_AIR_TUBED_MM), [CAL_AIR_TUBELEN](../../19.高级调参/parameter_reference.md#CAL_AIR_TUBELEN).

## Calibration

Airspeed sensors should be calibrated by following the instructions: [Basic Configuration > Airspeed](../../07.标准配置/12.airspeed.md).

## See Also

- [Using the ECL EKF > Airspeed](../../19.高级调参/tuning_the_ecl_ekf.md#airspeed)
