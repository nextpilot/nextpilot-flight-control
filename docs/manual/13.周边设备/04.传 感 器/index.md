...
The minimal set of sensors is incorporated into [Pixhawk Series](../01.基本概念/pixhawk_series.md) flight controllers (and may also be in other controller platforms).
...
- [GPS/Compass](../21.周边设备/04.传 感 器/01.卫星导航/README.md)
- RTK GNSS (GPS(../21.周边设备/04.传 感 器/01.卫星导航/rtk_gps.md)

:::note
[Pixhawk-series](../01.基本概念/pixhawk_series.md) controllers include an *internal* compass. Due to electromagnetic interference caused by power cables close to the flight controller, it is highly recommended to not rely on the internal compass for heading estimation and instead to mount an external one.
:::
...
For more information and recommended hardware see: [Airspeed Sensors](../21.周边设备/04.传 感 器/airspeed.md).
...
For more information see: [Distance Sensors](../21.周边设备/04.传 感 器/rangefinders.md).

<img src="/assets/hardware/sensors/lidar_lite/lidar_lite_1.png" title="lidar_lite_1" width="500px" />

## Optical Flow

[Optical Flow sensors](../21.周边设备/04.传 感 器/optical_flow.md) use a downward facing camera and a downward facing distance sensor for velocity estimation.
...
- [Peripheral Hardware](../21.周边设备/README.md) contains documentation for other sensors, such as [Battery/Power Monitors](../21.周边设备/12.电源模块/README.md)), [Air traffic warning systems](../21.周边设备/adsb_flarm.md), [Tachometers](../21.周边设备/04.传 感 器/tachometers.md).
- [Basic Assembly](../02.快速入门/03.设备安装/README.md) contains flight controller quick start guides.
  These explain how to connect the core sensors to specific flight controller hardware.
- [Flight Controller](../01.基本概念/README.md) topics often contain wiring information.
