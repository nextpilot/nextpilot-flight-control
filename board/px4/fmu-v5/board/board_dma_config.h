...
#define SDIO_DMA_TX_IRQHandler DMA2_Stream3_IRQHandler
#define SDIO_TX_DMA_RCC        RCC_AHB1ENR_DMA2EN
#define SDIO_TX_DMA_INSTANCE   DMA2_Stream3
#define SDIO_TX_DMA_CHANNEL    DMA_CHANNEL_4
#define SDIO_TX_DMA_IRQ        DMA2_Stream3_IRQn
...
#define SDIO_DMA_RX_IRQHandler DMA2_Stream6_IRQHandler
#define SDIO_RX_DMA_RCC        RCC_AHB1ENR_DMA2EN
#define SDIO_RX_DMA_INSTANCE   DMA2_Stream6
#define SDIO_RX_DMA_CHANNEL    DMA_CHANNEL_4
#define SDIO_RX_DMA_IRQ        DMA2_Stream6_IRQn
#endif
