...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC1_IN8
    */
    HAL_GPIO_DeInit(GPIOC, SCALED_V5_Pin|SCALED_VDD_3V3_SENSORS_Pin|HW_VER_SENSE_Pin|HW_REV_SENSE_Pin
                          |ADC1_SPARE_1_Pin);

    HAL_GPIO_DeInit(GPIOA, BAT1_I_Pin|BAT1_V_Pin|ADC1_SPARE_2_Pin|BAT2_V_Pin
                          |BAT2_I_Pin);

    HAL_GPIO_DeInit(RSSI_IN_GPIO_Port, RSSI_IN_Pin);
...
void HAL_CAN_MspDeInit(CAN_HandleTypeDef* hcan)
{
  ...
  /* USER CODE END CAN3_MspDeInit 0 */
    ...
    PA8     ------> CAN3_RX
    */
    HAL_GPIO_DeInit(GPIOA, CAN3_TX_Pin|CAN3_RX_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(I2C1_SCL_GPS1_GPIO_Port, I2C1_SCL_GPS1_Pin);

    HAL_GPIO_DeInit(I2C1_SDA_GPS1_GPIO_Port, I2C1_SDA_GPS1_Pin);
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PF1     ------> I2C2_SCL
    */
    HAL_GPIO_DeInit(I2C2_SDA_UART4_GPIO_Port, I2C2_SDA_UART4_Pin);

    HAL_GPIO_DeInit(I2C2_SCL_UART4_GPIO_Port, I2C2_SCL_UART4_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PH7     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(I2C3_SDA_EXTERNAL3_GPIO_Port, I2C3_SDA_EXTERNAL3_Pin);

    HAL_GPIO_DeInit(I2C3_SCL_EXTERNAL3_GPIO_Port, I2C3_SCL_EXTERNAL3_Pin);
  ...
  /* USER CODE END I2C4_MspDeInit 0 */
    ...
    PF14     ------> I2C4_SCL
    */
    HAL_GPIO_DeInit(I2C4_SDA_EXTERNAL2_GPIO_Port, I2C4_SDA_EXTERNAL2_Pin);

    HAL_GPIO_DeInit(I2C4_SCL_EXTERNAL2_GPIO_Port, I2C4_SCL_EXTERNAL2_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI4_MspInit 0 */
    ...
    PE13     ------> SPI4_MISO
    */
    GPIO_InitStruct.Pin = SPI4_SCK_SENSOR2_Pin|SPI4_MOSI_SENSOR2_Pin|SPI4_MISO_SENSOR2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA6     ------> SPI1_MISO
    */
    HAL_GPIO_DeInit(SPI1_MOSI_SENSOR1_GPIO_Port, SPI1_MOSI_SENSOR1_Pin);

    HAL_GPIO_DeInit(SPI1_SCK_SENSOR1_GPIO_Port, SPI1_SCK_SENSOR1_Pin);

    HAL_GPIO_DeInit(SPI1_MISO_SENSOR1_GPIO_Port, SPI1_MISO_SENSOR1_Pin);
  ...
  /* USER CODE END SPI4_MspDeInit 0 */
    ...
    PE13     ------> SPI4_MISO
    */
    HAL_GPIO_DeInit(GPIOE, SPI4_SCK_SENSOR2_Pin|SPI4_MOSI_SENSOR2_Pin|SPI4_MISO_SENSOR2_Pin);
  ...
  /* USER CODE END SPI5_MspDeInit 0 */
    ...
    PF8     ------> SPI5_MISO
    */
    HAL_GPIO_DeInit(GPIOF, SPI5_SCK_EXTERNAL1_Pin|SPI5_MOSI_EXTERNAL1_Pin|SPI5_MISO_EXTERNAL1_Pin);
  ...
  /* USER CODE END SPI6_MspDeInit 0 */
    ...
    PG12     ------> SPI6_MISO
    */
    HAL_GPIO_DeInit(SPI6_MOSI_EXTERNAL2_GPIO_Port, SPI6_MOSI_EXTERNAL2_Pin);

    HAL_GPIO_DeInit(GPIOG, SPI6_SCK_EXTERNAL2_Pin|SPI6_MISO_EXTERNAL2_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PI5     ------> TIM8_CH1
    */
    HAL_GPIO_DeInit(RC_INPUT_GPIO_Port, RC_INPUT_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PD1     ------> UART4_TX
    */
    HAL_GPIO_DeInit(GPIOD, UART4_RX_I2C2_Pin|UART4_TX_I2C2_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB6     ------> USART1_TX
    */
    HAL_GPIO_DeInit(GPIOB, USART1_RX_GPS1_Pin|USART1_TX_GPS1_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PG8     ------> USART6_RTS
    */
    HAL_GPIO_DeInit(GPIOG, USART6_TX_TELEM3_Pin|USART6_CTS_TELEM3_Pin|USART6_RX_TELEM3_Pin|USART6_RTS_TELEM3_Pin);
...
void HAL_PCD_MspDeInit(PCD_HandleTypeDef* hpcd)
{
  ...
  /* USER CODE END USB_OTG_FS_MspDeInit 0 */
    ...
    PA9     ------> USB_OTG_FS_VBUS
    */
    HAL_GPIO_DeInit(GPIOA, USB_DP_Pin|USB_DM_Pin|VBUS_Pin);
